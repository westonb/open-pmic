...
N 210 -740 210 -560 { lab=vdd}
N 210 -740 410 -740 { lab=vdd}
N 250 -530 290 -530 { lab=vdd}
N 210 -600 290 -600 { lab=vdd}
N 210 -500 210 -460 { lab=#net1}
N 210 -460 410 -460 { lab=#net1}
N 290 -600 290 -530 { lab=vdd}
N 1970 -740 1970 -720 { lab=vdd}
N 1760 -740 1970 -740 { lab=vdd}
N 1930 -740 1930 -690 { lab=vdd}
N 1970 -660 1970 -630 { lab=vdd}
N 1840 -740 1840 -590 { lab=vdd}
N 1740 -550 1810 -550 { lab=vout}
N 660 -820 660 -290 { lab=#net2}
N 660 -820 1900 -820 { lab=#net2}
N 1900 -820 1900 -550 { lab=#net2}
N 1870 -550 1900 -550 { lab=#net2}
N 2030 -380 2030 -310 { lab=vss}
N 2030 -250 2030 -140 { lab=vss}
N 1740 -140 2030 -140 { lab=vss}
N 1970 -280 1990 -280 { lab=vss}
N 1970 -280 1970 -200 { lab=vss}
N 1970 -200 2030 -200 { lab=vss}
N 1740 -370 1840 -370 { lab=vout}
N 1870 -330 1870 -140 { lab=vss}
N 1900 -370 1930 -370 { lab=vmid}
N 1930 -370 1930 -100 { lab=vmid}
N 1930 -100 1930 -50 { lab=vmid}
N 1500 -50 1930 -50 { lab=vmid}
N 1500 -350 1500 -50 { lab=vmid}
N 1320 -350 1500 -350 { lab=vmid}
N 870 -310 870 -140 { lab=vss}
N 900 -350 1120 -350 { lab=#net3}
N 720 -350 840 -350 { lab=#net3}
N 720 -350 720 -260 { lab=#net3}
N 720 -260 750 -260 { lab=#net3}
N 750 -260 750 -240 { lab=#net3}
N 870 -140 870 -40 { lab=vss}
N 900 0 920 0 { lab=vss}
N 920 -60 920 0 { lab=vss}
N 870 -60 920 -60 { lab=vss}
N 690 -260 720 -260 { lab=#net3}
N 690 -260 690 0 { lab=#net3}
N 690 0 840 -0 { lab=#net3}
N 2030 -380 2080 -380 { lab=vss}
N 2080 -380 2080 -200 { lab=vss}
N 2030 -200 2080 -200 { lab=vss}
N 1930 -630 1970 -630 { lab=vdd}
N 1930 -690 1930 -630 { lab=vdd}
N 750 -420 790 -420 { lab=#net3}
N 790 -420 790 -350 { lab=#net3}
N 720 -380 810 -380 { lab=vss}
N 810 -380 810 -300 { lab=vss}
N 810 -300 870 -300 { lab=vss}
N 690 -420 690 -320 { lab=#net2}
N 580 -320 690 -320 { lab=#net2}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 230 -530 0 1 {name=dum_top_pmos
L=1
W=5
nf=1
mult=4
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1950 -690 0 0 {name=dum_mid_pmos_out
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1840 -570 3 1 {name=dum_mid_pmos_in
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 2010 -280 0 0 {name=dum_mid_nmos_out
L=1
W=5
nf=1
mult=2
...
C {devices/lab_pin.sym} 1970 -690 0 1 {name=l20 sig_type=std_logic lab=vdd


}
C {devices/lab_pin.sym} 1840 -550 1 1 {name=l21 sig_type=std_logic lab=vdd




}
C {devices/lab_pin.sym} 2030 -280 0 1 {name=l22 sig_type=std_logic lab=vss




}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1870 -350 1 1 {name=dum_mid_nmos_in
L=1
W=5
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 870 -330 3 0 {name=dum_nmos_bot_in_right
L=1
W=5
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 870 -20 3 1 {name=dum_nmos_bot_out
L=1
W=5
nf=1
mult=2
...
C {devices/lab_pin.sym} 1870 -370 3 1 {name=l23 sig_type=std_logic lab=vss




}
C {devices/lab_pin.sym} 870 0 1 1 {name=l24 sig_type=std_logic lab=vss




}
C {devices/lab_pin.sym} 870 -350 3 1 {name=l25 sig_type=std_logic lab=vss




}
C {devices/lab_pin.sym} 210 -530 0 0 {name=l26 sig_type=std_logic lab=vdd




}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 720 -400 1 1 {name=dum_nmos_bot_in_left
L=1
W=5
nf=1
mult=1
...
C {devices/lab_pin.sym} 720 -420 3 1 {name=l27 sig_type=std_logic lab=vss
