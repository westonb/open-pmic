...
N 1500 -420 1500 -400 { lab=BIAS_CMP}
...
C {devices/lab_wire.sym} 1500 -400 0 1 {name=l20 sig_type=std_logic lab=BIAS_CMP}
C {devices/lab_wire.sym} 1380 -340 0 1 {name=l21 sig_type=std_logic lab=ISLOPE}
...
C {devices/iopin.sym} 0 -440 0 0 {name=p12 lab=IMON
}
